...
sql = "replace into {} (item_id,item_title,item_title_url,category_id,main_image_url," \
...
class GetItemInfo(ApiRequest):
    ...
    def get_item_info_thread(self,url):
        ...
        if info_dic:
            ...
            insert_sql = sql.format(self.table_name,info_dic["item_id"],MySQLdb.escape_string(info_dic["item_title"]),MySQLdb.escape_string(info_dic["item_title_url"]),
                                    str(info_dic["category_id"]),MySQLdb.escape_string(info_dic["main_image_url"]),MySQLdb.escape_string(info_dic["other_image_url"]),
                                    str(info_dic["item_price"]),str(info_dic["item_sales"]),str(info_dic["item_scores"]),MySQLdb.escape_string(info_dic["item_description"]),
                                    MySQLdb.escape_string(info_dic["item_specifics"]),MySQLdb.escape_string(info_dic["item_packaging"]),str(info_dic["item_quantity"]),
                                    MySQLdb.escape_string(info_dic["item_variations"]),MySQLdb.escape_string(info_dic["attr_name"]),MySQLdb.escape_string(info_dic["variations_image"]))
